...
Public Class frm_user
    ...
    Private Sub frm_adduser_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            reloadDtg("Select user_id as 'ID' ,name as 'Name',user_name as 'Username',type as 'Type' From user where user_name != 'admin'", dtg_listUser)
    ...
    Private Sub btn_Eliminar_Click(sender As Object, e As EventArgs) Handles btn_Eliminar.Click
        sql = "DELETE FROM user WHERE `user_id`='" & dtg_listUser.CurrentRow.Cells("ID").Value & "'"
        deletes(sql, dtg_listUser.CurrentRow.Cells("ID").Value, dtg_listUser.CurrentRow.Cells("ID").Value)
        '----------------------------------
        cbo_type.Text = "Administrator"
        reloadDtg("Select user_id as 'ID' ,name as 'Name',user_name as 'Username',type as 'Type' From user where user_name != 'admin'", dtg_listUser)
        dtg_listUser.Columns(0).Visible = True
